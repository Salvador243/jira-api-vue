...
const submitForm = () => {
    ...
    createIsuue(formData.value); // Aquí se puede hacer el envío del formulario
};
                        ...
                        <form id="form-adjuntos" ref="adjuntosForm" @submit.prevent="submitForm">
                            <div class="card issue">
                                <div class="card-header">
                                    <div class="row">
                                        <span><strong>Datos de la incidencia | </strong>Información de la incidencia a
                                            reportar</span>
                                    </div>
                                </div>
                                <div class="card-body">
                            ...
                            <div class="card mt-3 issue">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" v-model="formData.notificar" type="checkbox"
                                                    value="" id="notificar">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" v-model="formData.llamadas" type="checkbox"
                                                    value="" id="llamadas">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="" id="mensajesTexto"
                                                v-model="formData.mensajes">
                                            <label class="form-check-label" for="mensajesTexto">
                                                Mensajes de texto
                                            </label>
                                        </div>
                                    </div>
